...
class fcnNet(BasicModule):
    def __init__(self, path):
        self.inplanes = 16
        super(fcnNet, self).__init__(path)
        block = BasicBlock
        ...
        self.avgpool = nn.MaxPool2d(3)    # input 30 8 , 20 5

        self.out1 = nn.Conv2d(32, 2, 3, 1, padding=1)
        self.out2 = nn.Conv2d(128, 2, 3, 1, padding=1)
        # self.fc2 = nn.Linear(128, 1)
        # self.maxpool1 = nn.MaxPool2d(3, 2, padding=1)
        
        # # self.conv5 = nn.Conv2d(64+64,64+64, 3, 1, padding=1)
