...
class outsModel(BasicModule):
    '''
    in 40x40
    '''
    def __init__(self, path):
        self.inplanes = 16
        super(outsModel, self).__init__(path)
        block = BasicBlock
        ...
        self.fp1 = nn.FractionalMaxPool2d(3, output_ratio=(0.7, 0.7))
        self.fp2 = nn.FractionalMaxPool2d(3, output_ratio=(0.7, 0.7))
        self.fp3 = nn.FractionalMaxPool2d(3, output_ratio=(0.7, 0.7))
